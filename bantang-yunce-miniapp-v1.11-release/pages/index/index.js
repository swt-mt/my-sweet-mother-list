const { loadChecklistState, loadFeedbackList, loadAuth } = require('../../utils/storage')
const { createOverviewModel } = require('../../utils/view-model')
const { stageMeta, flatItems } = require('../../utils/catalog')
const { trackEvent } = require('../../utils/analytics')

Page({
  data: { auth: loadAuth(), stageCards: [], stats: [], completionRate: 0, highlightCards: [] },
  ...
  refresh() {
    ...
    this.setData({ auth: loadAuth(), stageCards: overview.stageCards, stats, completionRate: overview.rate, highlightCards })
  },
